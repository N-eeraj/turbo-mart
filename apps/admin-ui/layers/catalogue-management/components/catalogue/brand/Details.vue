...
} from "@app/schemas/catalogue/brand"

interface Props {
  name: BrandCreationData["name"]
  slug: BrandCreationData["slug"]
  createdAt: BrandCreationData["createdAt"]
  updatedAt: BrandCreationData["updatedAt"]
}
